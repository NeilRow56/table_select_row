...
export const columns = [
  ...
  columnHelper.accessor('address.country', {
    size: 120,
    header: props => {
      return <HeaderCell title='Country' columnWidth={props.column.getSize()} />
    },
    cell: props => (
      <CountryCell
        columnWidth={props.column.getSize()}
  ...
  columnHelper.accessor('address.streetAddress', {
    header: props => {
      return <HeaderCell title='Address' columnWidth={props.column.getSize()} />
    },
    cell: props => (
      <TextCell columnWidth={props.column.getSize()} value={props.getValue()} />
    )
  ...
  columnHelper.accessor('business.companyName', {
    size: 220,
    header: props => {
      return <HeaderCell title='Company' columnWidth={props.column.getSize()} />
    },
    cell: props => (
      <TextCell columnWidth={props.column.getSize()} value={props.getValue()} />
    )
  ...
  columnHelper.accessor('business.iban', {
    size: 260,
    header: props => {
      return <HeaderCell title='IBAN' columnWidth={props.column.getSize()} />
    },
    cell: props => (
      <TextCell columnWidth={props.column.getSize()} value={props.getValue()} />
    )
